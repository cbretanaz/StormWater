...
namespace CoP.Enterprise.Controls
{
    ...
    public class DataGridViewNumericUpDownCell : DataGridViewTextBoxCell
    {
        ...
        private const DataGridViewContentAlignment anyRight
            = DataGridViewContentAlignment.TopRight | 
              DataGridViewContentAlignment.MiddleRight | 
              DataGridViewContentAlignment.BottomRight;

        private const DataGridViewContentAlignment anyCenter 
        ...
        public int DecimalPlaces
        {
            ...
            set
            {
                ...
                OnCommonChange();  // Assure that the cell or column gets repainted and auto sized if needed
            }
        }
        ...
        public decimal Increment
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(
                        "The Increment property cannot be smaller than 0.");
                }
        ...
        public override void DetachEditingControl()
        {
            ...
            if (dataGridView.EditingControl is NumericUpDown nud)
            {
                ...
                if (nud.Controls[1] is TextBox textBox)  textBox.ClearUndo();
            }
        ...
        private bool OwnsEditingNumericUpDown(int rowIndex)
        {
            ...
            return DataGridView.EditingControl is DataGridViewNumericUpDownEditingControl nudEdtCtrl && 
                   rowIndex == ((IDataGridViewEditingControl)nudEdtCtrl).EditingControlRowIndex;
        }
        ...
        { return 
                anyRight.HasFlag(align) ? HorizontalAlignment.Right:
                anyCenter.HasFlag(align)? HorizontalAlignment.Center:
